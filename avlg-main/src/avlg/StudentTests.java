...
public class StudentTests {
    ...
    @Test
    public void testAVL3() throws InvalidBalanceException, EmptyTreeException{
    	tree = new AVLGTree<>(1);
    	
    	
    	
    	System.out.println(tree.isAVLGBalanced());
    }
    ...
    @Test
    public void testdeleteAVLG() throws InvalidBalanceException, EmptyTreeException {
    	tree = new AVLGTree<>(1);
        tree.insert(5);
        tree.insert(2);
        tree.insert(3);
