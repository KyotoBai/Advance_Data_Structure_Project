...
public class StudentTests {
    ...
    public void testArrayHeapInsertDelete(){
        myHeap = new ArrayMinHeap<>();
        myHeap.insert("Karathodori");
        myHeap.insert("Stergiou");
		myHeap.insert("Leooe");
		myHeap.insert("Sakurajima");
		
		try {
			assertEquals("Karathodori",myHeap.deleteMin());
			assertEquals("Leooe",myHeap.deleteMin());
			assertEquals("Sakurajima",myHeap.deleteMin());
		} catch (EmptyHeapException e) {
			
		}
		
        /*
        Iterator iter = myHeap.iterator();
    ...
    @Test
    public void MinHeapPQIterator() throws InvalidPriorityException{
    	myQueue = new MinHeapPriorityQueue<>();
    	myQueue.enqueue("Karathodori", 3);
    	myQueue.enqueue("Stergiou", 6);
    	myQueue.enqueue("Leooe", 6);
    	myQueue.enqueue("Sakurajima", 1);
    	myQueue.enqueue("Dick", 6);
