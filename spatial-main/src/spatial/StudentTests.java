...
public class StudentTests {
    ...
    public void testKDTreeFewInsertions(){
        ...
        //System.out.println(kdTree.nearestNeighbor(pt1));
    }
    
    @Test
    public void testKDTreeMoreInsertions(){
        kdTree = new KDTree(2);
        ...
        KDPoint pt1 = new KDPoint(7, 3);
    }
    
    @Test
    public void testKDTreeNN_1D(){
        kdTree = new KDTree(1);
        
        KDPoint pt1 = new KDPoint(4);
        
        kdTree.insert(new KDPoint(4));
        kdTree.insert(new KDPoint(5));
        kdTree.insert(new KDPoint(6));
        kdTree.insert(new KDPoint(8));
        kdTree.insert(new KDPoint(12));
        
        //kdTree.nearestNeighbor(pt1);
        kdTree.height();
    }
    
    @Test
    public void testKDTreeNN_2D(){
        kdTree = new KDTree(2);
        
        KDPoint pt1 = new KDPoint(7, 0);
    ...
    @Test
    public void testKDTreeMore(){
        kdTree = new KDTree(2);
        
        KDPoint pt1 = new KDPoint(0, -2);
        KDPoint pt2 = new KDPoint(-1, 3);
        KDPoint pt3 = new KDPoint(2, 8);
        KDPoint pt4 = new KDPoint(-2, -2);
        KDPoint pt5 = new KDPoint(3, 4);
    ...
    @Test
    public void testKDTreeHW(){
        kdTree = new KDTree(4);
        
        kdTree.insert(new KDPoint(20, 7, 8, -1));
        kdTree.insert(new KDPoint(10, 50, 28, 70));
        kdTree.insert(new KDPoint(15, 51, 28, 70));
        kdTree.insert(new KDPoint(30, 0, 2, 3));
        kdTree.insert(new KDPoint(25, 1, 2, 3));
        kdTree.insert(new KDPoint(15, 51, 28, 60));
        kdTree.insert(new KDPoint(15, 51, 28, 50));
        kdTree.insert(new KDPoint(16, 51, 30, 0));
        kdTree.insert(new KDPoint(10, 60, 30, 50));
        kdTree.insert(new KDPoint(3, 55, 40, 58));
        
     
    }
    
    @Test
    public void testKDTreeTESTQ4(){
    	prQuadTree = new PRQuadTree(5, 2); // Space from (-8, -8) to (8, 8), bucketing parameter = 2.
        
        prQuadTree.insert(new KDPoint(-4,3));
        prQuadTree.insert(new KDPoint(-10,-12));
        prQuadTree.insert(new KDPoint(-12,9));
        prQuadTree.insert(new KDPoint(5,3));
        prQuadTree.insert(new KDPoint(-5,-3));
        prQuadTree.insert(new KDPoint(-1,2));
        prQuadTree.insert(new KDPoint(-13,-11));
        prQuadTree.insert(new KDPoint(-12,-14));
        
        prQuadTree.delete(new KDPoint(-5,-3));
        prQuadTree.delete(new KDPoint(-13,-11));
    }
    ...
    @Test
    public void testPRQuadTreeInsertDelete(){
        prQuadTree = new PRQuadTree(4, 2); // Space from (-8, -8) to (8, 8), bucketing parameter = 2.
        prQuadTree.insert(new KDPoint(1, 1));
        KDPoint pt1 = new KDPoint(2, 2);
        prQuadTree.insert(pt1); 
        
        prQuadTree.insert(new KDPoint(6, 6)); 
        prQuadTree.delete(new KDPoint(6, 7));
    }
    
    @Test
    public void testPRQuadTreeTEST31(){
        prQuadTree = new PRQuadTree(6, 2); // Space from (-8, -8) to (8, 8), bucketing parameter = 2.
        
        prQuadTree.insert(new KDPoint(-2, 6));
        prQuadTree.insert(new KDPoint(-6, 2));
        prQuadTree.insert(new KDPoint(-11, 7));
        prQuadTree.insert(new KDPoint(-11, 2));
        prQuadTree.insert(new KDPoint(-15, 7));
        
        prQuadTree.delete(new KDPoint(-11, 7));
    }

    @Test
    public void testPRQuadTreeMoreRange(){
        prQuadTree = new PRQuadTree(5, 2); // Space from (-8, -8) to (8, 8), bucketing parameter = 2.
        
        prQuadTree.insert(new KDPoint(4, 0));
        prQuadTree.insert(new KDPoint(-9, 9));
        prQuadTree.insert(new KDPoint(-5, 15));
        prQuadTree.insert(new KDPoint(-8, 7));
        prQuadTree.insert(new KDPoint(-3, 6));
        prQuadTree.insert(new KDPoint(-13, -11));
        prQuadTree.insert(new KDPoint(-12, -15));
        prQuadTree.insert(new KDPoint(-4, 14));
        prQuadTree.insert(new KDPoint(5, -1));
        prQuadTree.insert(new KDPoint(3, -6));
        prQuadTree.insert(new KDPoint(14, -2));
        prQuadTree.insert(new KDPoint(8, -7));
        prQuadTree.insert(new KDPoint(13, -10));
        
        prQuadTree.range(new KDPoint(8, -2), 14);
    }

    @Test
    public void testPRQuadTreeMoreKNN(){
        prQuadTree = new PRQuadTree(5, 2); // Space from (-8, -8) to (8, 8), bucketing parameter = 2.
        ...
        prQuadTree.kNearestNeighbors(5, new KDPoint(8, -2));
    }
    
    @Test
    public void testPRQuadTreeTEST42(){
        prQuadTree = new PRQuadTree(4, 2); // Space from (-8, -8) to (8, 8), bucketing parameter = 2.
        
        prQuadTree.insert(new KDPoint(2, 2));
        prQuadTree.insert(new KDPoint(3, 3));
        prQuadTree.insert(new KDPoint(5, 5));
        prQuadTree.insert(new KDPoint(6, 6));
        prQuadTree.insert(new KDPoint(-7, 1));
        prQuadTree.insert(new KDPoint(-7, 4));
        prQuadTree.insert(new KDPoint(-1, 2));
        
        prQuadTree.kNearestNeighbors(4, new KDPoint(-2, 2));
    }
